...
SECRET_KEY = 'zu9axplsxvpj+nx1*ov(s4nq11wjd%ou$rlx)fclk!k8yai*^9'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'hospital_app/media')
...
from .email_vars import email_name, email_psw
