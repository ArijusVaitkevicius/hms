...
urlpatterns = [
    ...
    path("patients/<int:pk>/update", views.PatientUpdateView.as_view(), name='update_patient'),
    ...
    path("doctors/<int:pk>/update", views.DoctorUpdateView.as_view(), name='update_doctor'),
